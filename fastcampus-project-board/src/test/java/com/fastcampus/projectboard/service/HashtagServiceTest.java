...
class HashtagServiceTest {
    ...
    void givenContent_whenParsing_thenReturnsUniqueHasgtagNames(String input, Set<String> expected) {
        //given
    ...
    static Stream<Arguments> givenContent_whenParsing_thenReturnsUniqueHasgtagNames() {
        return Stream.of(
